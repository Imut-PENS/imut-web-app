            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @if (Auth::guard('employee')->check() || Auth::guard()->check())
                            <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        @if (Auth::guard('employee')->check())
                                            <a class="dropdown-item" href="/backend/pages/dashboard">Dashboard</a>
                                        @else   
                        ...
                        <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="linkDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('employee.login') }}">
                                        {{ __('Employee') }}
                                    </a>
                                </div>
                            </li>
